...
if getattr(sys, "frozen", False):
	ROOT_FOLDER = os.environ.get("WT_MODEL_VIEWER_VENDOR_ROOT")
	if not ROOT_FOLDER:
		base_dir = getattr(sys, "_MEIPASS", path.dirname(sys.executable))
		ROOT_FOLDER = path.join(base_dir, "vendor", "dae_runtime")
else:
	ROOT_FOLDER = os.environ.get("WT_MODEL_VIEWER_VENDOR_ROOT")
	if not ROOT_FOLDER:
